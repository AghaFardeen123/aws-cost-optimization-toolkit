...
def render_markdown(findings: dict[str, Any], title: str = "AWS Cost Audit Report") -> str:
    ...
    sections.append(
        ...
        f"(${findings['total_potential_annual_savings']}/year)**\n"
    )
    ...
    sections.append(
        _table(
            ...
            [
                [f["resource_id"], f["size_gb"], f"${f['monthly_cost']}", f["recommendation"]]
    ...
    sections.append(
        _table(
            ...
            [
                [f["resource_id"], f["public_ip"], f"${f['monthly_cost']}", f["recommendation"]]
